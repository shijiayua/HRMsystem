...
public class Resume {
    ...
    public Resume(int id, String name, Integer age, String sex, String education, String tel, String email, String application_job, String politic_status, String last_job, String experience, String expected_salary, String hobby) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.sex = sex;
    ...
    public Resume(String name, Integer age, String sex, String education, String tel, String email, String application_job, String politic_status, String last_job, String experience, String expected_salary, String hobby) {
        this.name = name;
        this.age = age;
        this.sex = sex;
        this.education = education;
